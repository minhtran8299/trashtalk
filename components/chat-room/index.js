...
//update typing status
  const typingStatus = () => {
    firestore()
      ...
      .update({
        typing: props.Auth().currentUser.typing? false : true,
      });
  };
        ...
        <View style={styles.innerContainer}>
          ...
          <View style={styles.newMessage}>
            <TextInput
              ...
              value={messageText}
              //update typing value to true and locatiton when text changes (aka user starts typing)
              onChangeText={text => {setMessageText(text) ; typingStatus(); updateLocation() }}
              multiline={true}
              onSubmitEditing={() => submitMessage()}
              returnKeyType="done"
              blurOnSubmit={true}
              />
              {/* update typing value to false when message is sent */}
            <TouchableOpacity style={styles.addIcon} onPress={() => {submitMessage(); typingStatus()}} >
